...
if (! function_exists('app_path')) {
    ...
    {
        return helpers . phpapp('path') . ($path ? DIRECTORY_SEPARATOR . $path : $path);
    }
}
...
if (! function_exists('base_path')) {
    ...
    {
        return helpers . phpapp()->basePath() . ($path ? DIRECTORY_SEPARATOR . $path : $path);
    }
}
...
if (! function_exists('config_path')) {
    ...
    {
        return helpers . phpapp()->make('path.config') . ($path ? DIRECTORY_SEPARATOR . $path : $path);
    }
}
...
if (! function_exists('public_path')) {
    ...
    {
        return helpers . phpapp()->make('path.public') . ($path ? DIRECTORY_SEPARATOR . ltrim($path, DIRECTORY_SEPARATOR) : $path);
    }
}
...
if (! function_exists('storage_path')) {
    ...
    {
        return helpers . phpapp('path.storage') . ($path ? DIRECTORY_SEPARATOR . $path : $path);
    }
}
